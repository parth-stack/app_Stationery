...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupSpinner();
        /**
         *receiving uri from intent started from listView.OnItemClickListener
         */
            ...
            case R.id.action_delete:
                ...
                builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (rowsDeleted == 0) {
                            Toast.makeText(getApplicationContext(), "delete_pet_failed", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(getApplicationContext(), "delete_pet_successful", Toast.LENGTH_SHORT).show();
                        }
                        finish();
                    }
                });
    ...
    private void savePetData() {
        ...
        int gender=mGender;
        if (mCurrentPetUri == null && TextUtils.isEmpty(nameString) && TextUtils.isEmpty(breedString) && TextUtils.isEmpty(weightString) && gender == PetContract.PetEntry.GENDER_UNKNOWN) {
            return;
        }
        ...
        if(mCurrentPetUri==null) {
            ...
            if (newUri == null) {
                ...
                Toast.makeText(this, "insert_pet_successful", Toast.LENGTH_SHORT).show();
            }
        }
        else{
            int rowsAffected = getContentResolver().update(mCurrentPetUri, values, null, null);
            if (rowsAffected == 0) {
                Toast.makeText(this, "editor_update_pet_failed at : "+ ContentUris.parseId(mCurrentPetUri), Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "editor_update_pet_successful at : "+ ContentUris.parseId(mCurrentPetUri), Toast.LENGTH_SHORT).show();
            }
        }
    }
